...
export default function ShopTheLookKids() {
  const { data: looks, isLoading } = useListLooks();
  const visibleLooks = (looks ?? []).filter((look: any) => (look.lookGroup ?? "main") === "kids");
    ...
    <div className="pb-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 mt-8">
        <div className="no-scrollbar flex items-center gap-8 overflow-x-auto text-[10px] tracking-[0.35em] uppercase text-muted-foreground">
          ...
          <Link href="/shop-the-look-kids" className="text-foreground border-b border-foreground pb-2">Kids</Link>
